...
DELOREAN=${DELOREAN:-https://trunk.rdoproject.org/centos7-rocky/current-passed-ci/delorean.repo}
DELOREAN_DEPS=${DELOREAN_DEPS:-https://trunk.rdoproject.org/centos7-rocky/delorean-deps.repo}
